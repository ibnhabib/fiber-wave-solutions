...
const CCTV = () => {
  ...
  return (
    <ServicePage
      ...
      content={content}
      features={features}
      imageUrl="https://plus.unsplash.com/premium_photo-1729210234080-dba7771d2389?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&fm=webp"
