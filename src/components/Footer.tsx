        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/network-installation" className="text-slate-600 hover:text-primary">Network Installation</Link></li>
              <li><Link to="/fiber-optic" className="text-slate-600 hover:text-primary">Fiber Optic Solutions</Link></li>
              <li><Link to="/wifi-setup" className="text-slate-600 hover:text-primary">WiFi & Networking Setup</Link></li>
              <li><Link to="/ethernet" className="text-slate-600 hover:text-primary">Ethernet & Home Networking</Link></li>
              <li><Link to="/cctv" className="text-slate-600 hover:text-primary">CCTV Installation</Link></li>
              <li><Link to="/voip" className="text-slate-600 hover:text-primary">VOIP Solutions</Link></li>
            </ul>
          </div>
